...
#s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data ("org-elpa" ("2021-08-02 21:43:18" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2021-08-02 21:43:18" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2021-08-02 21:43:18" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "el-get" ("2021-08-02 21:43:18" nil (:type git :host github :repo "dimitri/el-get" :build nil :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :flavor melpa :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2021-08-02 21:43:18" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "straight" ("2021-08-02 21:43:18" ("emacs") (:type git :host github :repo "raxod502/straight.el" :files ("straight*.el") :branch "master" :package "straight" :local-repo "straight.el")) "org-roam" ("2021-08-02 21:43:19" ("emacs" "dash" "f" "s" "org" "emacsql" "emacsql-sqlite3") (:type git :host github :repo "org-roam/org-roam-v1" :flavor melpa :package "org-roam" :local-repo "org-roam-v1")) "dash" ("2021-08-02 21:43:19" ("emacs") (:type git :flavor melpa :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el" :package "dash" :local-repo "dash.el")) "f" ("2021-08-02 21:43:19" ("s" "dash") (:type git :flavor melpa :files ("f.el" "f-pkg.el") :host github :repo "rejeep/f.el" :package "f" :local-repo "f.el")) "s" ("2021-08-02 21:43:19" nil (:type git :flavor melpa :files ("s.el" "s-pkg.el") :host github :repo "magnars/s.el" :package "s" :local-repo "s.el")) "org" ("2021-08-02 21:43:19" ("emacs") (:type git :repo "https://code.orgmode.org/bzg/org-mode.git" :local-repo "org" :depth full :pre-build (straight-recipes-org-elpa--build) :build (:not autoloads) :files (:defaults "lisp/*.el" ("etc/styles/" "etc/styles/*")) :package "org")) "emacsql" ("2021-08-02 21:43:19" ("emacs") (:type git :flavor melpa :files ("emacsql.el" "emacsql-compiler.el" "emacsql-system.el" "README.md" "emacsql-pkg.el") :host github :repo "skeeto/emacsql" :package "emacsql" :local-repo "emacsql")) "emacsql-sqlite3" ("2021-08-02 21:43:19" ("emacs" "emacsql") (:type git :flavor melpa :host github :repo "cireu/emacsql-sqlite3" :package "emacsql-sqlite3" :local-repo "emacsql-sqlite3"))))
...
This allows Dash symbols to be looked up with \\[info-lookup-symbol]." t nil) (register-definition-prefixes "dash" '("!cdr" "!cons" "--" "->" "-a" "-butlast" "-c" "-d" "-e" "-f" "-gr" "-i" "-juxt" "-keep" "-l" "-m" "-no" "-o" "-p" "-r" "-s" "-t" "-u" "-value-to-list" "-when-let" "-zip" "dash-")) (provide 'dash-autoloads)) "s" ((s-autoloads s) (register-definition-prefixes "s" '("s-")) (provide 's-autoloads)) "f" ((f f-autoloads) (register-definition-prefixes "f" '("f-")) (provide 'f-autoloads)) "org" ((ol-irc ol-eshell ob-ruby ob-java ob-J org-attach ob-perl ob-picolisp ob-lisp ox-ascii ol-rmail org-refile ob-shen ob-sql ol-eww ob-matlab ob-eshell org-keys org-capture ob-fortran ob-hledger ox ob-ledger ob-stan ob-abc org-datetree org-agenda ox-icalendar ox-org ob-exp ob-dot org-faces oc-biblatex ob-haskell ol-bibtex ob-ref ob-coq ob-asymptote org-goto org-crypt ob-processing ob-maxima org-mouse ox-latex ob-clojure org-loaddefs ob-io ob-groovy org-install ob-core ox-odt ob-scheme ob-python ol-doi org-timer ob-sed ol-gnus ox-md ol org-duration org-version ox-beamer org-plot ob-lua ol-w3m org-tempo ob-js org-list ob-comint ob-table org-compat ob-ocaml org-clock org-ctags org-colview ob-tangle ob-vala oc ol-bbdb ob-css ox-html org org-lint org-footnote org-num ob-C ob-awk org-feed ob-org org-table oc-csl ob-calc ob-screen org-archive org-protocol org-mobile ox-texinfo ox-man org-inlinetask ob-lilypond ob-sass org-macs org-attach-git org-habit org-entities org-src org-pcomplete ob ob-forth ol-info ob-gnuplot oc-basic ol-mhe ob-shell ob-plantuml org-indent ox-publish ob-ebnf org-id oc-natbib ob-lob org-element ob-R ob-mscgen ob-latex ol-docview ob-emacs-lisp ob-makefile ob-sqlite ox-koma-letter org-macro ob-eval ob-ditaa ob-octave)) "emacsql" ((emacsql emacsql-autoloads emacsql-compiler) (autoload 'emacsql-show-last-sql "emacsql" "Display the compiled SQL of the s-expression SQL expression before point.
A prefix argument causes the SQL to be printed into the current buffer.

(fn &optional PREFIX)" t nil) (register-definition-prefixes "emacsql" '("emacsql-")) (register-definition-prefixes "emacsql-compiler" '("emacsql-")) (provide 'emacsql-autoloads)) "emacsql-sqlite3" ((emacsql-sqlite3 emacsql-sqlite3-autoloads) (register-definition-prefixes "emacsql-sqlite3" '("emacsql-sqlite3-")) (provide 'emacsql-sqlite3-autoloads)) "org-roam" ((org-roam-link org-roam-macs org-roam-graph org-roam-db org-roam-autoloads org-roam-completion org-roam-buffer org-roam-dailies org-roam org-roam-faces org-roam-capture org-roam-compat org-roam-dev org-roam-protocol org-roam-doctor) (defvar org-roam-mode nil "Non-nil if Org-roam mode is enabled.
